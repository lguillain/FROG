...
const exampleConfig = {
  ...
  questions: [
    {
      question: 'Laquelle de ces expressions est fausse? AB',
      answers: [
    ...
    {
      question: 'Laquelle de ces expressions est fausse?A',
      answers: [
    ...
    {
      question: 'Laquelle de ces expressions est juste?A',
      answers: [
    ...
    {
      question:
        'Pour deux événements $A$ et $B$ indépendants, laquelle de ces expressions est juste?L',
      answers: [
        '$P(A \\cup B) = P(A) + P(B)$',
    ...
    {
      question:
        'Un cadenas à numéros possède trois roues; chacune porte les numéros 0 à 9. Combien de "nombres" secrets y a-t-il?L',
    ...
    {
      question:
        'Laquelle des fonctions suivantes est-elle une densité de probabilité?L',
      answers: [
...
export const meta = {
  name: 'MCQ with sound in Questions',
